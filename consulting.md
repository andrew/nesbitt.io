...
Over fifteen years I've built [Libraries.io](https://libraries.io), [Ecosyste.ms](https://ecosyste.ms), [git-pkgs](https://github.com/andrew/git-pkgs), the [Manifest podcast](https://manifest.fm), co-organised the [Package Management devroom at FOSDEM](https://fosdem.org/2025/schedule/track/package-management/), and contributed to [Homebrew](https://brew.sh). All from the same obsession: understanding how software gets assembled from other people's software.
...
**Get in touch:** [andrew@nesbitt.io](mailto:andrew@nesbitt.io) or [Mastodon](https://mastodon.social/@andrewnez).
