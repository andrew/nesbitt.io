...
[`Brewfile`](https://docs.brew.sh/Brew-Bundle-and-Brewfile) is generated by `brew bundle dump` and consumed by `brew bundle install`, turning a system package manager into something you can commit to a repository. I built the [original version](https://github.com/Homebrew/homebrew-bundle) of `brew bundle` years ago, and it's grown well beyond what I first put together.
