...
[mise 2026.5.15](https://github.com/jdx/mise/releases/tag/v2026.5.15) recognises `loongarch64` and `riscv64` as valid platform arches, so lockfiles targeting those no longer fall back to the common platform set.

Also out: [Deno 2.8.1](https://github.com/denoland/deno/releases/tag/v2.8.1), [Homebrew 5.1.14](https://github.com/Homebrew/brew/releases/tag/5.1.14), [conda 26.5.1](https://github.com/conda/conda/releases/tag/26.5.1), [vcpkg 2026-05-27](https://github.com/microsoft/vcpkg-tool/releases/tag/2026-05-27), [Verdaccio 6.7.2](https://github.com/verdaccio/verdaccio/releases/tag/v6.7.2), [snapd 2.75.2.2](https://github.com/canonical/snapd/releases/tag/2.75.2.2).

## Articles

Daniel Stenberg on [the pressure on the curl project right now](https://daniel.haxx.se/blog/2026/05/26/the-pressure/).
