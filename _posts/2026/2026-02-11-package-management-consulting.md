...
date: 2026-02-11 10:00 +0000
description: "I'm now available for consulting on package management, software supply chain security, and open source infrastructure."
tags:
  - package-managers
  - consulting
...
**Package manager design & architecture.** If you're building a package manager, registry, or dependency resolver, or trying to fix one, I can help you avoid the mistakes that RubyGems, npm, and PyPI learned the hard way. I've documented the design patterns, tradeoffs, and failure modes across dozens of ecosystems in my [cross-ecosystem package manager documentation](/package-managers/). Namespace design, version constraint semantics, lockfile formats, registry APIs, lifecycle hooks, trust models.

**Software supply chain security.** I've found and catalogued dependency confusion attacks, typosquatting campaigns, [slopsquatting](https://en.wikipedia.org/wiki/Slopsquatting) (a term I popularized), malicious maintainer takeovers, and protestware incidents across every major ecosystem. Trusted publishing, SBOM generation and enrichment, vulnerability scanning strategy. I know what actually works and what's security theatre.
...
**Research & analysis.** Guest lectures, technical reports, ecosystem comparisons, landscape surveys. I've presented at [FOSDEM](https://fosdem.org) and [NYU Secure Systems Lab](https://ssl.engineering.nyu.edu/), spoken at the [Software Mentions in OpenAlex workshop](https://blog.openalex.org/linking-the-worlds-research-to-the-code-it-runs-on/), and contributed to research with [Software Heritage](https://www.softwareheritage.org/), [CHAOSS](https://chaoss.community/), and [OpenSSF](https://openssf.org/).
...
I'm based in the UK and work remotely. I've worked at [GitHub](https://github.com) and [Tidelift](https://tidelift.com). Past clients include package registry operators, open source foundations (CHAOSS, OpenSSF), enterprise platform teams, and academic research groups (NYU, Software Heritage).

Get in touch at [andrew@nesbitt.io](mailto:andrew@nesbitt.io) or on [Mastodon](https://mastodon.social/@andrewnez). More detail on my [consulting page](/consulting/).
